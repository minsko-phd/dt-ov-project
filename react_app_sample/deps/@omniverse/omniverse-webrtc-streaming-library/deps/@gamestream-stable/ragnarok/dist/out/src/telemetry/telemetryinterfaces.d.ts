import { GdprLevel, ResumeType, OverrideConfigTypeEnum, CodecType, IPVersion, NetworkTypeEnum, BooleanType, TelemetryEventBase, ClientTelemetryConfig, TelemetryEventPayload } from "../dependencies";
