...
import { NetworkTypeEnum } from "./internaltypes";
...
export declare function IsVisionPro(platform: PlatformDetails): boolean;
/**
...
/**
 * type to be used for header in performHttpRequest options arg.
 */
 ...
 */
export declare function IsSafariVersionAtLeast(platformDetails: PlatformDetails, major: number, minor?: number): boolean;
/**
 * @param platformDetails - interface: PlatformDetails
 ...
 */
export declare function convertNetworkTypeToTelemetryType(network: NetworkType): NetworkTypeEnum;
