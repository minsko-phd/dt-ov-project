/**
 * Represents the config override information source and its version.
 */
export interface RemoteOverrideInfo {
...
/** Format of configuration parameters from GXT server.
 * Example values: {  name: "ragnarok", value: {<all configurations of Ragnarok>}, version:"x.y" }
 */
export declare interface GxtConfigParams {
    name: string;
    value: Object;
    version: string;
}
/** GXT remote configuration data format. */
export declare interface GxtRemoteConfigData {
    debugInfo: {
        revision: string /** version info of the response, refer GxtConfigParams.version for individual configuration version */;
    };
...
export declare interface GS_WsCallResult {
    retryCount: number;
    sessionId: string;
    subSessionId: string;
    serverId: string;
    ...
    cleanDisconnection: BooleanType;
    networkType: NetworkTypeEnum;
    statusCode: string;
    cmsId: string;
    moduleName: GSModuleName;
...
export declare class GS_WsCallResultDef extends TelemetryEventBase<GS_WsCallResult> {
    readonly name: string;
    readonly gdprLevel: GdprLevel;
    constructor(info: GS_WsCallResult);
}
