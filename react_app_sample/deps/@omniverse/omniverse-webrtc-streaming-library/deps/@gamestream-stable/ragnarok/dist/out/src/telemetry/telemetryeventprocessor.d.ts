...
import { EventDataElements } from "../interfaces";
...
export declare class TelemetryEventProcessor {
    ...
    updateCachedExitEvent(exitErrorCode: string, sessionId: string, subSessionId: string, zoneAddress: string, streamDuration: number, frameCount: number, codec: VideoCodecType, isResume: boolean): void;
