export declare const enum RErrorCode {
    ...
    InvalidServiceResponse = 3237093672,
    ...
    SessionWaitingAdsTimeExpired = 3237093711,
    UserCancelledWatchingAds = 3237093712,
    ...
    StreamerHangingGetFailure = 3237093891,
    ...
    StreamGamepadChannelError = 3237093929,
    StreamerGamepadChannelNotOpen = 3237093936,
    StreamerNeedAudioElement = 3237093937,
    ...
    ServerDisconnectedNoResponse = 3237094145,
    ...
    ServerDisconnectedUserLoggedInDifferentAccount = 15868706,
    ...
    ServerDisconnectedMultipleTab = 15868752,
